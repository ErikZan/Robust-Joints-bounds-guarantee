...
x_des = np.array([[0.21128912,  0.4062898 ,  1.24693176, -0.01354349,  0.0326968 , 0.38244455,  0.92330042]]).T;
...
#    ddx_des2[:3,t] = kp*M.rotation.T*(M_des.translation - M.translation) - kd*J[:3,:]*dq[:,t];
    ...
    if(GOAL_REACHED==False and np.linalg.norm(M_des.translation - M.translation) < 3e-3):
